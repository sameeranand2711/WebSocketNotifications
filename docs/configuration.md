...
The maximum sizes, buffer capacity, and one-hour heartbeat ceiling are internal hard safety limits. Invalid settings are rejected rather than clamped. Heartbeat duration settings remain validated even when heartbeat is disabled.
